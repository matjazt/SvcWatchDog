...
See [**NotificationServer**](https://github.com/matjazt/NotificationServer) demo project for a practical example of how to integrate **SvcWatchDog** with a C# application.
